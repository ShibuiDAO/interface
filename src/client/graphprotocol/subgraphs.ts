export enum Subgraph {
	...
	BOBA_MAINNET_ERC721EXCHANGE = 'https://graph.mainnet.boba.network:8000/subgraphs/name/shibuidao/nft-exchange',
	BOBA_RINKEBY_ERC721EXCHANGE = 'https://graph.rinkeby.boba.network:8000/subgraphs/name/shibuidao/nft-exchange'
}
